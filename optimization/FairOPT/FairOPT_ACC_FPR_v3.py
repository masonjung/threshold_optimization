    ...
    def optimize(self):
        ...
        while iteration < self.max_iterations:
            ...
            for group in self.group_indices.keys():
                ...
                self.thresholds[group] = np.clip(self.thresholds[group], (0.5-0.1) + 1e-7, (0.5+0.1)- 1e-7) # 7 decimal points
...
for source in unique_sources:
    ...
    for detector in detector_probabilities:
        ...
        with open("C:\\Users\\minse\\Desktop\\Programming\\FairThresholdOptimization\\results_updated3.txt", "a") as f:
